...
TomTomLocals = {
	...
	["%d yards"] = "%d mètres",
	["%s (%.2f, %.2f)"] = "%s (%.2f, %.2f)",
	["%s yards away"] = "à %s mètres",
	["%s%s - %s %s %s %s"] = "%s%s - %s %s %s %s",
	["%s%s - %s (map: %d)"] = "%s%s - %s (carte : %d)",
	["%s: (map: %d, zone: %s, continent: %s, world: %s)"] = "%s : (carte : %d, zone : %s, continent : %s, monde : %s)",
	["%s: No coordinate information found for '%s' at this map level"] = "%s : aucune information de coordonnées trouvée pour « %s » à ce niveau de carte",
	...
	["Arrow locked"] = "Flèche verrouillée",
	...
	["Clear waypoint from crazy arrow"] = "Supprimer le point de passage de la flèche",
	...
	["Controls the frequency of updates for the crazy arrow LDB feed."] = "Contrôle la fréquence des mises à jour du flux LDB de la flèche.",
	...
	["Crazy Arrow feed throttle"] = "Limitation du flux de la flèche",
	...
	["Enable minimap waypoints"] = "Activer les points de passage sur la minicarte.",
	...
	["Enables a menu when right-clicking on a waypoint allowing you to clear or remove waypoints"] = "Activer un menu lors d'un clic droit sur un point de passage, permettant de l'effacer ou le supprimer",
	...
	["Hide the crazy arrow display during pet battles"] = "Masquer l'affichage de la flèche pendant les combats de mascottes",
	["Icon Control"] = "Contrôle des icônes",
	["If you have changed the waypoint display settings (minimap, world), this will reset all waypoints to the current options."] = "Si vous avez modifié les paramètres d'affichage des points de passage (minicarte, carte du monde), cette option réinitialisera tous les points de passage selon les paramètres actuels.",
	...
	["Minimap Icon Size"] = "Taille de l'icône de la minicarte",
	...
	["New Gold Blue Dot"] = "Nouveau point bleu doré",
	["New Gold Green Dot"] = "Nouveau point vert doré",
	["New Gold Purple Dot"] = "Nouveau point violet doré",
	["New Gold Red Dot"] = "Nouveau point rouge doré",
	["New Purple Ring"] = "Nouvel anneau violet",
	["No"] = "Non",
	...
	["Old Gold Green Dot"] = "Ancien point vert doré",
	...
	["Resets the position of the waypoint arrow if its been dragged off screen"] = "Réinitialiser la position de la flèche du point de passage si elle a été déplacée hors de l'écran",
	...
	["The color to be displayed when you are halfway between the direction of the active waypoint and the completely wrong direction"] = "Couleur affichée lorsque vous êtes à mi-chemin entre la direction du point de passage actif et la direction opposée",
	["The color to be displayed when you are moving in the direction of the active waypoint"] = "Couleur affichée lorsque vous vous déplacez dans la direction du point de passage actif",
	["The color to be displayed when you are moving in the exact direction of the active waypoint"] = "Couleur affichée lorsque vous vous déplacez exactement dans la direction du point de passage actif",
	["The color to be displayed when you are moving in the opposite direction of the active waypoint"] = "Couleur affichée lorsque vous vous déplacez dans la direction opposée au point de passage actif",
	["The display of the coordinate block can be customized by changing the options below."] = "L'affichage du cadre des coordonnées peut être personnalisé à l'aide des options ci-dessous.",
	["The floating waypoint arrow can change color depending on whether or nor you are facing your destination.  By default it will display green when you are facing it directly, and red when you are facing away from it.  These colors can be changed in this section.  Setting these options to the same color will cause the arrow to not change color at all"] = "La flèche flottante du point de passage peut changer de couleur selon que vous êtes ou non orienté vers votre destination. Par défaut, elle s'affiche en vert lorsque vous êtes bien orienté, et en rouge lorsque vous faites face à la direction opposée. Ces couleurs peuvent être modifiées dans cette section. Si les deux couleurs sont identiques, la flèche ne changera pas de couleur.",
	...
	["This setting allows you to control the default size of the minimap icon. "] = "Ce paramètre permet de contrôler la taille par défaut de l'icône de la minicarte.",
	...
	["This setting allows you to select the default icon for the minimap"] = "Ce paramètre permet de sélectionner l'icône par défaut pour la minicarte.",
	["This setting allows you to select the default icon for the world map"] = "Ce paramètre permet de sélectionner l'icône par défaut pour la carte du monde.",
	...
	["TomTom can display multiple waypoint arrows on the minimap.  These options control the display of these waypoints"] = "TomTom peut afficher plusieurs flèches de points de passage sur la minicarte. Ces options contrôlent leur affichage.",
	...
	["TomTom provides an arrow that can be placed anywhere on the screen.  Similar to the arrow in \"Crazy Taxi\" it will point you towards your next waypoint"] = "TomTom propose une flèche pouvant être placée n'importe où à l'écran. Similaire à celle de « Crazy Taxi », elle indique la direction de votre prochain point de passage.",
	["TomTom provides you with a floating coordinate display that can be used to determine your current position.  These options can be used to enable or disable this display, or customize the block's display."] = "TomTom offre un affichage flottant des coordonnées permettant de déterminer votre position actuelle. Ces options permettent d'activer, de désactiver ou de personnaliser ce cadre.",
	["TomTom waypoint"] = "Point de passage TomTom",
	["TomTom's saved variables are organized so you can have shared options across all your characters, while having different sets of waypoints for each.  These options sections allow you to change the saved variable configurations so you can set up per-character options, or even share waypoints between characters"] = "Les variables sauvegardées de TomTom sont organisées de façon à permettre le partage des options entre tous vos personnages, tout en conservant des ensembles de points de passage distincts pour chacun. Ces sections d'options permettent de modifier ces configurations pour définir des paramètres par personnage ou partager les points de passage entre eux.",
	...
	["World Map Icon"] = "Icône de la carte du monde",

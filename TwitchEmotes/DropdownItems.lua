...
TwitchEmotes_dropdown_options = {
    [01] = { -- 45
        ...
        "asmonE1", "asmonE2", "asmonE3", "asmonE4", "asmonFiend", "asmonG",
        "asmonGASM", "asmonGet", "asmonHide", "asmonL", "asmonBoi", "asmonLove",
        "asmonLong1", "asmonLong2", "asmonLong3", "asmonLong4", "asmonM",
        "asmonOcean", "asmonOrc", "asmonTar", "asmonP", "asmonPower",
        "asmonPray", "asmonPrime", "asmonR", "asmonREE", "asmonSad",
        "asmonStare", "asmonTiger", "asmonUH", "asmonW", "asmonWHAT",
        "asmonWHATR", "asmonWOW"
    },
    [02] = { -- 40
    ...
    [03] = { -- 45
        "BTTV+FFZ 1", "4Head", "ANELE", "AngelThump", "BibleThump", "bUrself",
        "BBona", "BabyRage", "BlessRNG", "BloodTrail", "ConcernDoge",
        "DogeWitIt", "ConcernFroge", "cmonBrother", "cmonBruh", "cmonBrug",
        "HYPERBRUG", "WTFF", "DansGame", "DatSheffy", "D:", "DD:", "FacePalm",
        "EleGiggle", "eShrug", "FailFish", "FrankerZ", "GabeN", "gachiGASM",
        "gachiHYPER", "HandsUp", "GivePLZ", "TakeNRG", "haHAA", "HeyGuys",
        "HotPokket", "HYPERLUL", "LUL", "LULW", "MegaLUL", "MingLUL", "MingLee",
        "Jebaited", "KKomrade", "ZULUL", "ZULOL"
    },
    [04] = { -- 44
        "BTTV+FFZ 2", "Kappa", "Kapp", "KappaPride", "Keepo", "Kreygasm",
        "MrDestructoid", "NotLikeThis", "NickyQ", "OhMyDog", "OpieOP", "smileW",
        "smileC", "RSmile", "RSmiling", "RFrown", "RGasp", "RCool", "RMeh",
        "RWink", "RWinkTongue", "RTongue", "RPatch", "o_O", "RTired", "RHeart",
        "PartyTime", "PowerUpL", "PowerUpR", "ResidentSleeper", "SeemsGood",
        "SMOrc", "Squid1", "Squid2", "Squid3", "Squid4", "SwiftRage", "Thonk",
        "HYPERTHONK", "WideHard", "TriHard", "weSmart", "WinnerWinner",
        "WutFace", "WutFaceW"
    },
    [05] = { -- 37
    ...
    [07] = { -- 33
        ...
        "KEKSad", "KEKL", "KEKLeo", "pOg", "Pogey", "PogeyU", "KKonaW", "kkOna",
        "Pogomega", "cmonEyes", "TriKool", "5Hard", "TriPeek", "TriEasy",
        "TriGold", "TriHardo", "0Head", "1Head", "2Head", "3Head", "3Lass",
        "4HEader", "4Weird", "4Shrug", "4Mansion", "BroKiss", "HomieL",
        "HomieR", "5Head"
    },
    [08] = { -- 31
        "Custom 4", "PogWarts", "noxSorry", "noxWhat", "BaconEffect", ":fluff:",
        "PATHETIC", "TriHardS", "HYPERDANSGAMEW", "MaN", "NaM", "VaN",
        "WhiteKnight", "BlackKnight", "PikaWOW", "Boomer", "Zoomer", "Coomer",
        "StareChamp", "starechamp", "WeirdChamp", "OkayChamp", "MaldChamp",
        "WutChamp", "SadChamp", "OkayChomp", "SillyChamp", "LULChamp",
        "CrazyChamp", "WeirdBruh", ":misery:", ":empty:", "sunglassesflushed",
        "flushdoggo"
    },
    [09] = { -- 28
        "Custom 5", "beamB", "CaptainSuze",
        "mumes", "peepoKnifeNANI", "peepoStab", "peepoH", "PepeClown",
        "SadHonk", "ClownPain", "ClownBall", "SchubertSmile", "PepeKing",
        "peepoKing", "peepoCrown", "peepoWeirdCrown", "PepeScience",
        "peepoCozy", "suzeOK", "ANELELUL", "bubby", "FeelsCozyMan",
        "peepoCheer", "peepoCry", "peepoDK", "peepoMad", "PepeChill",
        "PepeCool", "EZGiggle"
    },
    [10] = { -- 32
    ...
    [11] = { -- 26
        "Greekgodx", "greekA", "greekBrow", "greekDiet", "greekGirl",
        "greekGordo", "greekGweek", "greekHard", "greekJoy", "greekKek",
        "greekM", "greekMlady", "greekOi", "greekP", "greekHYPERP",
        "greekThink", "greekPVC", "greekSad", "greekSheep", "greekSleeper",
    ...
    [15] = { -- 45
        ...
        ":writing_hand:", ":wave:", ":clock:", ":crab:", ":onion:", ":tomato:",
        ":pig:", ":lizard:", ":rage:", ":eye:", ":eyes:", ":b:", ":eggplant:",
        ":sweat_drops:", ":peach:", ":tongue:", ":heart:", ":kiss:", ":100:",
        ":mega:", ":bell:", ":crown:"
    },
    [16] = { -- 39
        "Forsen 1", "forsen1", "forsen2", "forsen3", "forsen4", "forsenAYAYA",
        "forsenAYOYO", "forsenBanned", "forsenBee", "forsenBlob", "forsenBoys",
        "forsenC", "forsenCD", "forsenChamp", "forsenClown",
        "forsenConnoisseur", "forsenCool", "forsenD", "forsenDab", "forsenDank",
        "forsenDDK", "forsenDED", "forsenDiglett", "forsenE", "forsenEcardo",
        "forsenEmote", "forsenEmote2", "forsenFajita", "forsenFeels",
        "forsenFur", "forsenG", "forsenGa", "forsenGASM", "forsenGrill",
        "forsenGun", "forsenH", "forsenHappy", "forsenHead", "forsenHobo"
    },
    [17] = { -- 38
        "Forsen 2", "forsenIQ", "forsenJoy", "forsenK", "forsenKek",
        "forsenKnife", "forsenKraken", "forsenL", "forsenLewd", "forsenLicence",
        "forsenLooted", "forsenLUL", "forsenM", "forsenMald", "forsenMoney",
        "forsenMonkey", "forsenNam", "forsenO", "forsenODO", "forsenOG",
        "forsenOP", "forsenP", "forsenPepe", "forsenPog", "forsenPosture",
        "forsenPosture1", "forsenPosture2", "forsenPuke", "forsenPuke2",
        "forsenPuke3", "forsenPuke4", "forsenPuke5", "forsenR", "forsenReally",
        "forsenRedSonic", "forsenRP", "forsenS", "forsenSambool", "forsenScoots"
    },
    [18] = { -- 24
        "Forsen 3", "forsenSheffy", "forsenSith", "forsenSkip", "forsenSleeper",
        "forsenSmile", "forsenSS", "forsenStein", "forsenSwag", "forsenT",
        "forsenTILT", "forsenTriggered", "forsenW", "forsenWC", "forsenWeird",
        "forsenWeird25", "forsenWhat", "forsenWhip", "forsenWitch", "forsenWTF",
        "forsenWut", "forsenX", "forsenY", "forsenYHD", "forsenHorsen"
    },
    [19] = { -- 44
        "AdmiralBahroo", "rooAww", "rooBlank", "rooBless", "rooBlind",
        "rooBonk", "rooBooli", "rooBot", "rooCarry", "rooCop", "rooCry",
        "rooCult", "rooD", "rooDab", "rooDerp", "rooDevil", "rooDisgust",
        "rooEZ", "rooGift", "rooHappy", "rooLick", "rooLick2", "rooLove",
        "rooMurica", "rooNap", "rooSleepy", "rooNom", "rooPog", "rooPs",
        "rooREE", "rooScheme", "rooSellout", "rooSmush", "rooThink", "rooTHIVV",
    ...
    [22] = { -- 35
        ...
        "PoggersHype", "yikers", "FeelsDrunkMan", "PepeThumbsUp",
        "FeelsEvilMan", "NOP", "UHM", "YEP", "FeelsGamerMan", "FeelsSad",
        "SadHug", "FeelsMyFingerMan", "FeelsStrongMan", "monkaVirus", ":think:",
    ...
    [23] = { -- 35
        ...
        "monkaTOS", "NA", "nanoMEGA", "peep", "PepeHands", "KEKWHands",
        "PepperHands", "PepeL", "PepePoint", "PepeOK", "PepeNotOK", "PepoThink",
    ...
    [26] = { -- 36
        ...
        "peepoPat", "peepoSick", "peepoBlush", "peepoThink", "peepoPlot",
    ...
    [27] = { -- 33
        ...
        "peepoKEKW", "peepoCringe", "peepoExit", "peepoGun", "peepoPoint",
        "peepoNOO", "peepoGlad", "peepoTeddy", "peepoUgh", "peepoSuspect",

...
L["You have entered |cffd9d919%s %s|r. Enable logging for this area?"] = "Vous êtes entré dans |cffd9d919%s %s.|r Voulez-vous activer les logs pour cette zone/instance ?"

...
private.CONTAINER_GUIDE = {
	...
	["3860862133"] = { 
		[RSConstants.STEP1] = { x = 0.2875, y = 0.5530, comment = AL["NOTE_386086_1"] };
		[RSConstants.STEP2] = { x = 0.2995, y = 0.4797, comment = AL["NOTE_386086_1"] };
		[RSConstants.STEP3] = { x = 0.3441, y = 0.4571, comment = AL["NOTE_386086_1"] };
	}; --Seething Cache
}

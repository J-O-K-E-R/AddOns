...
L["CONFIG_SHOPPING_LIST_FULL_REFRESH"] = "点击更新按钮时更新所有页面"
L["CONFIG_SHOPPING_LIST_FULL_REFRESH_TOOLTIP_HEADER"] = "更新所有页面"
L["CONFIG_SHOPPING_LIST_FULL_REFRESH_TOOLTIP_TEXT"] = "只需要第一页的数据就可以确定最便宜的价格，如果您只对最便宜的价格感兴趣也不需要查看其余结果，则可以关闭此选项以提高速度。"
